...
$(function () {
    ...
    /*Configuración calendario Coogranada*/
    ...
    $('.calendario').pickadate({
        ...
        formatSubmit: 'yyyy-mm-dd',
        selectYears: true, //Permite seleccionar el año
        selectYears: 120,//Cantidad de años seleccionable
        selectMonths: true,//Permite seleccionar el mes
        //firstDay: 1, //Indica desde que número de dia      
        //showMonthsShort: true,//Indica si muestra el nombre del mes de forma corta
        today: 'Hoy',//Muestra el boton que cambia a la fecha del dia de hoy
        close: 'Cerrar',//Muestra el boton que cierra el calendario
        clear: '',//Muestra el boton que limpia el campo que contiene la fecha
        monthsFull: ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'],//Nombre completo de los meses
        monthsShort: ['Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul', 'Ago', 'Sep', 'Oct', 'Nov', 'Dic'],//Nombre corto de los meses
        weekdaysFull: ['Domingo', 'Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado'],//Nombre completo de los días de la semana
        weekdaysShort: ['Dom', 'Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sáb'],//Nombre corto de los días de la semana
        highlightSelectedDate: true,//Si distinguir o no visualmente la fecha seleccionada
        highlightToday: true,   //Si distinguir o no visualmente la fecha de hoy
        max: [ano, mes, dia]   //La última fecha que un usuario puede seleccionar
    });
    /*Fin configuración calendario Coogranada*/
});
